...
func TestDefaulting(t *testing.T) {
	...
	typesWithDefaulting := map[schema.GroupVersionKind]struct{}{
		...
		{Group: "podsecuritypolicy.admission.k8s.io", Version: "v1beta1", Kind: "PodSecurityPolicy"}:            {},
		{Group: "podsecuritypolicy.admission.k8s.io", Version: "v1beta1", Kind: "PodSecurityPolicyList"}:        {},
