...
import (
	...
	v1beta1 "k8s.io/client-go/listers/podsecuritypolicy/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PodsecuritypolicyV1beta1().PodSecurityPolicies().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PodsecuritypolicyV1beta1().PodSecurityPolicies().Watch(options)
			},
		},
		&podsecuritypolicy_v1beta1.PodSecurityPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *podSecurityPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&podsecuritypolicy_v1beta1.PodSecurityPolicy{}, f.defaultInformer)
}
